                ...
                {activeTab === 'data' && (
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <DataItemList items={items} onChange={setItems} showSuffix={showSuffix} />
                    </div>
                  </>
                )}
          ...
          <div className="flex-1 flex flex-col bg-background min-w-0">
            <div className="px-5 py-2.5 border-b border-border flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <div className={`w-2 h-2 rounded-full ${items.length > 0 ? 'bg-success' : 'bg-muted-foreground/30'}`} />
                <span className="text-[10px] text-muted-foreground">
                  {items.length > 0 ? 'Atualizado' : 'Sem dados'}
                </span>
              </div>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center p-8 overflow-auto">
              ...
              >
                {question.title && (
                  <motion.h3 layout className="text-lg font-semibold text-foreground text-center mb-1">
                    {question.title}
                  </motion.h3>
                )}
                {question.description && (
                  <motion.p layout className="text-sm text-muted-foreground text-center mb-6">
                    {question.description}
                  </motion.p>
                )}
