...
import { SidebarContext, type SidebarContextValue, useSidebar } from "@/components/ui/sidebarContext";
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center overflow-hidden rounded-md text-left outline-none ring-sidebar-ring transition-[width,height,padding] focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        default: "h-10 text-sm gap-3 px-4",
        sm: "h-7 text-xs gap-2 px-2",
        lg: "h-12 text-sm gap-3 px-4 group-data-[collapsible=icon]:!p-0",
      },
    },
    defaultVariants: {
      variant: "default",
